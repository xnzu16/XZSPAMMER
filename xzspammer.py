...
def check_password():
    ...
    print(Colorate.Vertical(Colors.blue_to_purple, "Masukkan Password untuk mengakses program"))

    while True:
        user_input = input(Colorate.Vertical(Colors.blue_to_purple, "Password: "))
        if user_input == PASSWORD:
            print(Colorate.Vertical(Colors.green_to_blue, "Akses diberikan!"))
            break
        else:
            print(Colorate.Vertical(Colors.red_to_yellow, "Password salah, coba lagi!"))
...
# Cek password sebelum menjalankan program
check_password()
ngl()
